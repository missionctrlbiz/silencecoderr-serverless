...
function Contact() {
    ...
    const [isSubmitting, setIsSubmitting] = useState(false); // State to manage submit button disable and loading state
    ...
    const handleSubmit = async (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            try {
                ...
                setIsSubmitting(false); // Stop loading state after attempt (success or error)
            }
        } else {
    ...
    const isValidPhone = (phone) => {
        // Simplified phone number validation (must be numeric and at least 6 characters)
                        ...
                        <div className="row">
                            ...
                            <Fade triggerOnce duration={2000} direction='up' delay={300} className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <button type="submit" className="custom-btn bx-btn-1" disabled={isSubmitting}>
